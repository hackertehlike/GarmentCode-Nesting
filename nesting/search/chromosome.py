...
class Chromosome():
    ...
    def _mutate_split(self):
        #from nesting.data.panel_mapping import dispatch_split
    ...
    def _mutate_design_params(self):
        ...
        new_genes, new_design_params, success, change_info = Operators.design_params(
            self.genes,
            self.design_params,
            self.body_params,
        ...
        if success:
            ...
            self.calculate_fitness()
            if change_info:
                param, old_val, new_val = change_info
                self._record_mutation_stats(param, old_val, new_val, original_fitness)
            return True
