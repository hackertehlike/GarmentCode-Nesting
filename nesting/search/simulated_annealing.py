...
from nesting.core.layout import Piece, Container, Layout
...
class SimulatedAnnealing:
    ...
    def _save_state_svg(self, state: List[Piece], iteration: int, 
        ...
        try:
            import copy
            import svgwrite
            from nesting.core.layout import LayoutView
    ...
    def _design_params(self) -> tuple[List[Piece], dict]:
        ...
        new_pieces, new_design_params, success, _ = Operators.design_params(
            self.current_state,
            self.design_params,
            self.body_params,
